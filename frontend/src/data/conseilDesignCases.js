...
export const CONSEIL_DESIGN_CASES = [
  {
    ...
    conditions: [
      "CONDITION : l'exposition au dispositif ne peut pas être masquée au participant (présence physique perceptible) — double aveugle classique NON FAISABLE. Recommandé à la place : évaluation en aveugle par un évaluateur indépendant (cotation vidéo différée, en insu de l'allocation).",
    ...
    caveat: "m-YPAS est validée pour l'anxiété PRÉOPÉRATOIRE — un moment unique (induction anesthésique). Son usage en mesures répétées sur plusieurs séances de radiothérapie, comme le prévoit KOKORO, est une extrapolation hors du contexte de validation d'origine : à justifier explicitement dans le protocole, pas à supposer équivalente sans discussion.\n\nCe cas a aussi servi à trouver puis corriger deux vrais problèmes du moteur (29/07/2026) : (1) la détection du besoin d'aveugle ratait les claims subjectives en français (bug de mots-clés bilingues) ; (2) une fois corrigé, le moteur recommandait un sham/double-blind classique — infaisable pour une présence physique perceptible comme un robot. Corrigé pour recommander la vraie solution méthodologique : masquer l'ÉVALUATION du critère (cotation vidéo différée, évaluateur indépendant en insu de l'allocation) plutôt que l'exposition elle-même, impossible à cacher à un enfant.",
