...
{{
  ...
  "endpoints": [
    {{
      ...
      "description": "<texte du protocole décrivant comment le critère est mesuré/recueilli — ex: auto-questionnaire complété par le patient. Essentiel pour distinguer un critère subjectif (patient-rapporté) d'un critère objectif quand le nom seul ne le dit pas>",
